...
项目目标很简单：基于 `microsoft/markitdown`，做一个可以在 Windows 上运行的绿色版小工具，输入 Word 文件，输出 Markdown 文件。
...
This repository documents a project created with Codex collaboration.

The goal was simple: build a portable Windows app based on `microsoft/markitdown` that takes a Word file as input and exports a Markdown file as output.
...
- `PROMPTS.md`: the key prompts that drove the project
- `NOTES.md`: short bilingual notes about the workflow
